...
public interface GameState {
    ...
    /**
     * Return a boolean inidicating if Mister X must be hidden on the map.
     * In particular, Mister X must be hidden if the game mode is Detective and if
     * the current game round
     * number correspond to one of the reveal turns for Mister X (present in the
     * class Constants in folder commons).
     * 
