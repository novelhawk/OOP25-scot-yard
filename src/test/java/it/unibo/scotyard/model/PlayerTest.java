...
public class PlayerTest {
    ...
    public void testChangeNamePlayer(){
        final Player player = new Bobby(nodeBobby);
        assertEquals(player.getName(), CommonCostants.BOBBY_FULL_STRING);
        player.setName(CommonCostants.BOBBIES_STRING);
        assertEquals(player.getName(), CommonCostants.BOBBIES_STRING);
        assertNotEquals(player.getName(), CommonCostants.BOBBY_FULL_STRING);
    }
